...
<div class="about">
	<div class="container">
        ...
        <form method="post" action="addstock.jsp">
            <center>
            <table frame="box"  cellpadding="5"style="border-color:#ed2553">
                <thead>
                    <tr>
                       <th colspan="2"width="400"height="100"><H1 style="color:#ed2553"><center><b>ADDING STOCKS HERE</b></center></H1></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td width="400"height="100"><center><h3 style="color:#ed2553"><b>Name</b></h3></center></td>
                       <td width="400"height="00"><center><h3 style="color:#ed2553"><input type="text" name="name" id="name"value="" onblur="javascript:valname(this.value)"/></h3></center></td>
                    </tr>
                    <tr>
                        <td width="400"height="100"><center><h3 style="color:#ed2553"><b>Add Stock</b></h3></center></td>
                        <td width="400"height="100"><center><h3 style="color:#ed2553"><input type="text" name="stock" id="st"value=""onblur="javascript:valst(this.value)" /></h3></center></td>
                    </tr>
                            <tr>
