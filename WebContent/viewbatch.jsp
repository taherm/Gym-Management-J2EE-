...
<div class="about">
	<div class="container">
        <H1 style="color:#ed2553"><center><b>BATCH DETAILS</b></center></H1>
        ...
        <TABLE BORDER="2" frame="box"align="center">
            <TR>
                <TH width="200"height="50"><h3 style="color:#ed2553"><center><b>First Name<center><b></h3></TH>
                <TH width="200"height="50"><h3 style="color:#ed2553"><center><b>Last Name<center><b></h3></TH>
                
               
         <TH width="200"height="50"><h3 style="color:#ed2553"><center><b>Registration Date<center><b></h3></TH>
         
         <TH width="200"height="50"><h3 style="color:#ed2553"><center><b>Trainer<center><b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><center><b>Batch<center><b></h3></TH>
            ...
            <TD width="200"height="50"><h4 style="color:#ed2553"> <%= resultset.getString(6) %></h4></TD>
            
            <TD width="200"height="50"><h4 style="color:#ed2553"> <%= resultset.getString(9) %></h4></TD>
            <TD width="200"height="50"><h4 style="color:#ed2553"> <%= resultset.getString(10) %></h4></TD>
            </TR>
            <% } %>
        </TABLE>
