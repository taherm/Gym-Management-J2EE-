...
<div class="about">
	<div class="container">
        <H1 style="color:#ed2553"><center><b>Member Details</b></center></H1>
        ...
        <TABLE BORDER="2" frame="box">
            <TR>
                <TH width="200"height="50"><h3 style="color:#ed2553"><b>First Name</b></h3></TH>
                <TH width="200"height="50"><h3 style="color:#ed2553"><b>Last Name</b></h3></TH>
                <TH width="200"height="50"><h3 style="color:#ed2553"><b>Email</b></h3></TH>
                <TH width="200"height="50"><h3 style="color:#ed2553"><b>Username</b></h3></TH>
                <TH width="200"height="50"><h3 style="color:#ed2553"><b>Password</b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><b>Registration Date</b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><b>Height</b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><b>Weight</b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><b>Trainer</b></h3></TH>
         <TH width="200"height="50"><h3 style="color:#ed2553"><b>Batch</b></h3></TH>
         
            </TR>
            <% while(resultset.next()){ %>
            <TR>
                <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(1) %></h4></center></td>
                <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(2) %></h4></center></TD>
                <TD> <center><h4 style="color:#ed2553"><%= resultset.getString(3) %></h4></center></TD>
                <TD> <center><h4 style="color:#ed2553"><%= resultset.getString(4) %></h4></center></TD>
                <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(5) %></h4></center></TD>
            <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(6) %></h4></center></TD>
            <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(7) %></h4></center></TD>
            <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(8) %></h4></center></TD>
            <TD><center><h4 style="color:#ed2553"> <%= resultset.getString(9) %></h4></center></TD>
            <TD> <center><h4 style="color:#ed2553"><%= resultset.getString(10) %></h4></center></TD>
            </TR>
            <% } %>
